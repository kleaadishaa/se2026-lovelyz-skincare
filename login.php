    ...
    <div class="form-wrap">
        ...
        <div class="form-panel active" id="panel-login">
            <div class="form-heading">
                ...
                <p>Sign in to your Lovelyz account.</p>
            </div>
        ...
        <div class="form-panel" id="panel-register">
            ...
            <form action="" method="POST">
                <div class="field">
                    ...
                    <input type="text" id="reg-name" name="name" placeholder="Your name" autocomplete="name" required>
                ...
                <div class="field">
                    ...
                    <input type="password" id="reg-pass" name="password" placeholder="Min. 8 characters" autocomplete="new-password" required>
                    <i class="fa-solid fa-lock field-icon"></i>
                </div>
                <div class="field">
